...
stopwords = {}
stoplist = [' ','   ','哈哈哈','你','我','repost','request','他','她','吧','呵呵','嘻嘻','么','了','  ','的','...','是','哈哈','转发','微博','回复','哼','嗯','哦','http','cn','记者','\r\n','\n','\r']

regex = re.compile(r"[^\u4e00-\u9f5aa-zA-Z0-9]")

tagfile = open("test_new_0.txt",'w',encoding='UTF-8')
...
def handlefile(tfile):
    testfile = open(tfile,'r+',encoding='UTF-8',newline=None)
#    testfile.readline()
...
#    jieba.load_userdict('C:/han/work/dict/chinesenames.txt')
    ...
    #txt_filenames = 'fa-cps-4.13-0.txt'
    txt_filenames = 'test_new.txt'
