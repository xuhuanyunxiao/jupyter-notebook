...
def handlefile(tfile):
    testfile = open(tfile,'r+',newline=None,encoding='UTF-8')
...
#        handlefile(filename)
    ...
    txt_filenames = 'i_p.txt'
    tagfile = open("i_p_1.txt",'w',encoding='UTF-8')       
    handlefile(txt_filenames)
    tagfile.close()     
    
    txt_filenames = 'i_n.txt'
    tagfile = open("i_n_1.txt",'w',encoding='UTF-8')       
    handlefile(txt_filenames)
    tagfile.close()    
#    for filename in txt_filenames:
#        print ("handling file: "+filename)
