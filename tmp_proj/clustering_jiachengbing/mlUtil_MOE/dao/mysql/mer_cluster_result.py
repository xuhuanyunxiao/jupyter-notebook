...
class MergerClusterResult(BaseMysql):
    ...
    def delete_cluster_results_slor(self, end_time, is_manual, cluster_type, manual_id, save_group_id):
        # merge_cluster_result
        sql = """
        DELETE FROM cluster_result 
        WHERE create_time < '%s' 
        ...
        # sub_cluster_result
        sub_obj = SubClusterResult()
        sub_obj.delete_sub_cluster_results_slor(end_time, is_manual, cluster_type, manual_id, save_group_id)
