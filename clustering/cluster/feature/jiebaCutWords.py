...
gp_dir_path = os.path.dirname(os.path.dirname(dir_path))
user_dict_path = os.path.join(gp_dir_path, 'dict', 'userdict.txt')
...
# 停用词语料
stopwords = {}
stopwords_path = os.path.join(gp_dir_path, 'dict', 'stopWords.txt')
